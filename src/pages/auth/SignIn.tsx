    ...
    return (
        <div className="min-h-screen bg-white flex flex-col md:flex-row">
            ...
            <div className="flex-1 flex flex-col p-8 md:p-24 justify-center max-w-2xl w-full mx-auto">
                ...
                <h1 className="text-4xl font-extrabold text-[#1e0a3c] mb-8">Log in</h1>
                ...
                <div className="space-y-6">
                    ...
                    <Button className="w-full h-12 bg-[#d1410c] hover:bg-[#d1410c]/90 font-bold text-lg">Log In</Button>
                    ...
                    <div className="text-center mt-8">
                        <Link to="/signup" className="text-[#39364f] hover:text-[#d1410c] font-medium">Sign up for Nexus</Link>
                    </div>
                </div>
            </div>
        </div>
